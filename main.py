...
store1 = Store("'Березка'", "Осиновая роща, дом 4")
store2 = Store("'Лента'", "улица Кривая, дом 15")
store3 = Store("'ОК'", "Новый тупик, дом 1")
store4 = Store("'У Ашота'", "Ереванский переулок, дом 777")
